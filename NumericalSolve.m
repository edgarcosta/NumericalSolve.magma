...
intrinsic NewtonRaphson(f::Map[ModTupFld[RngReCom], ModTupFld[RngReCom]], x0::ModTupFldElt[RngReCom] : Derivative:=false, fx0:=false, prec:=false) -> ModTupFld[RngReCom]
{
...
intrinsic NewtonRaphson(f::Map[ModTupFld[RngReCom], ModTupFld[RngReCom]], x0::SeqEnum[RngReComElt] : Derivative:=false, fx0:=false, prec:=false) -> SeqEnum[RngReComElt]
{ " } //"
...
intrinsic NewtonRaphson(f::Map[ModTupFld[RngReCom], ModTupFld[RngReCom]], x0::ModMatFldElt[RngReCom] : Derivative:=false, fx0:=false, prec:=false) -> ModMatFldElt[RngReCom]
{ " } //"
  x := NewtonRaphson(f, Vector(x0) : Derivative:=Derivative, fx0:=fx0, prec:=prec);
  return Matrix([x]);
end intrinsic;
